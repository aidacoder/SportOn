...
const HeroSection = () => {
  return (
    <section id="hero-section" className="container mx-auto h-screen flex bg-amber-000">
      <div className="relative self-center">
        ...
        <div className="relative ml-20 w-full">
          <div className="text-orange-500 italic">Friday Sale, 50%</div>
          ...
          <div className="flex gap-5 mt-14">
            <Button className="bg-orange-500 w-[230px] h-[50px]">
        ...
        <Image
          ...
          className="absolute -right-0 top-62.5 -translate-y-1/2"
        />
      </div>
      <Image
