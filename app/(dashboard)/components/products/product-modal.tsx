...
import Modal from "../ui/modal"; import ImageUploadPreview from "../ui/image-upload-preview";
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={isEditMode?"edit product":"Add product"}>
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        ...
        <Button className="ml-auto mt-3 rounded-lg" onClick={handleSubmit}  disabled={isSubmitting}
          type="submit">{isEditMode ? "Update Product" : "Create Product"}</Button>
